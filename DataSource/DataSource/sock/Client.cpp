...
namespace OwLibSock
{
	...
	Client::Client(int type, int proxyType, const string &ip, u_short port, const string &proxyIp, u_short proxyPort, const string &proxyUserName, const string &proxyUserPwd, const string &proxyDomain, int timeout)
	{
	...
	int Client::SendTo(const char *str, int len)
	{
